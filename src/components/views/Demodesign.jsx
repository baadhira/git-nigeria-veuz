...
const TicketCard = ({ 
  ...
  return (
    <div className="relative w-80 bg-white rounded-2xl overflow-hidden shadow-xl">
      {/* Exclusive Badge - Exact triangular corner */}
      {isExclusive && (
        <div className="absolute top-0 left-0 z-20">
          {/* Triangle using clip-path */}
          <div 
            className="w-24 h-24 bg-green-500 flex items-center justify-center"
            style={{
              clipPath: 'polygon(0 0, 100% 0, 0 100%)'
            }}
          >
            <div className="absolute top-3 left-2 text-white text-xs font-bold transform -rotate-45 whitespace-nowrap">
              EXCLUSIVE
            </div>
          </div>
        </div>
